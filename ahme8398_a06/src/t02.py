...
input_1 = input("Enter a value to insert into Priority Queue 1, separated by spaces: ").split()
for i in input_1:
    Priority_Queue_1.insert(int(i))

input_2 = input("Enter a value to insert into Priority Queue 2, separated by spaces: ").split()
for i in input_2:
