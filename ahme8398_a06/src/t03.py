...
input_1 = input("Enter a value to insert into initial Deque, separated by spaces. This will be used for most tests: ").split()
for i in input_1:
...
Deque1 = Deque()
print("--insert_front--")
input_deque1 = input("Enter a value to insert into Deque1, separated by spaces: ").split()
...
Deque2 = Deque()
print("--insert_rear--")
input_deque2 = input("Enter a value to insert into Deque2, separated by spaces: ").split()
