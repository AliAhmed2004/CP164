...
class Queue:
    ...
    def split_alt(self):
        """
        -------------------------------------------------------
        Splits the source queue into separate target queues. target1
        contains every other value from source beginning at the front.
        target2 contains the remaining values from source.
        When finished, source queue is empty.
        (iterative algorithm)
