...
class Sorted_List:
    ...
    def combine(self, source1, source2):
        ...
        """
        # Your code here
        self._values = source1._values + source2._values
        self._values.sort()
        source1._values = []
        source2._values = []
    ...
    def max(self):
        ...
        if self._values != sorted(self._values, reverse=True):
    ...
    def split_apply(self, func):
        ...
        for value in self._values:
            if func(value): # func parameter is expected to be a function that takes a single argument (a value from the list) and returns a boolean value (True or False) based on some condition 
    ...
    def append(self, value):
        """
        -------------------------------------------------------
        Appends a copy of value to the end of the Sorted_List.
